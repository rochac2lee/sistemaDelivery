...
$dateFil = date('Y/m/d'); //24/01/2019

try {
		include("../includes/conexao.php");
		// RECEBENDO OS DADOS PREENCHIDOS DO FORMULÁRIO !
			
		$datafiltroIn = $dateFil." 00:00";
		$datafiltroFi = $dateFil." 23:59";
	...
	$select = "
		SELECT 
			RequisicaoDescarga.RegRequisicao, RequisicaoDescarga.DtRequisicao, RequisicaoDescarga.Motorista, RequisicaoDescarga.PlacaCavalo, RequisicaoDescarga.SitReg, RequisicaoDescarga.PesoBru,
